...
function Projects () {  
    ...
    return (
        <div className="projects-container">
            ...
            <ProjectCard title="Green Guard" description={description[0]} textButton="View repository" linkWebPage="https://github.com/nadissa1508/Green_guard" linkGithub="https://github.com/nadissa1508/Green_guard" projectPhoto={greenGuard} />
